...
public class Treap<K, V> extends AbstractMap<K, V> implements
    ...
    static final class TreapNode<K, V> implements Map.Entry<K, V> {
        private K key;
        private V value;
    ...
    public void deleteEntry(TreapNode<K, V> p) {
        modCount++;
        size--;
        ...
        TreapNode<K,V> replacement = (p.left != null ? p.left : p.right);
